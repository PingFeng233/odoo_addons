...
odoo.define('web_widget_x2many_2d_matrix.X2Many2dMatrixRenderer', function (require) {
  ...
  var X2Many2dMatrixRenderer = BasicRenderer.extend({
    ...
    _renderView: function () {
      ...
      $('div.o_field_one2many.o_field_widget.o_field_x2many.o_field_x2many_2d_matrix').unbind("keydown");
      $('table.o_list_view input.o_field_float.o_field_number.o_field_widget.o_input').unbind("keydown");
